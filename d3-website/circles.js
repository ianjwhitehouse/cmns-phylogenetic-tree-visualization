...
svg.append('text')
        ...
        .attr('font-weight','bold')
        .attr('font-family', 'serif')
        .attr('x', legend_labels_loc[0][0] - 350)
        .attr('y', legend_labels_loc[0][1] + 75)
...
svg.append('text')
        ...
        .attr('font-weight','bold')
        .attr('font-family', 'serif')
        .attr('x', legend_labels_loc[1][0] - 350)
        .attr('y', legend_labels_loc[1][1] - 170)
